...
func (*ChatSingleReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_291f9d13d5dcef72, []int{0}
}
...
func (*ChatSingleRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_291f9d13d5dcef72, []int{1}
}
...
func init() {
	proto.RegisterType((*ChatSingleReq)(nil), "im_main_proto.ChatSingleReq")
	proto.RegisterType((*ChatSingleRes)(nil), "im_main_proto.ChatSingleRes")
}

func init() { proto.RegisterFile("main_chat.proto", fileDescriptor_291f9d13d5dcef72) }

var fileDescriptor_291f9d13d5dcef72 = []byte{
	// 129 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0xe2, 0xcf, 0x4d, 0xcc, 0xcc,
	0x8b, 0x4f, 0xce, 0x48, 0x2c, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0xcd, 0xcc, 0x8d,
	...
	0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x30, 0xae, 0x12, 0x3f, 0xaa, 0xd2, 0x62, 0x27, 0x8d,
	0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc2, 0x63, 0x39,
	0x86, 0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96, 0x63, 0x88, 0xe2, 0xd3, 0x47, 0xb1, 0x25, 0x89,
	0x0d, 0x4c, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x2e, 0x1d, 0xcb, 0xfc, 0x8e, 0x00, 0x00,
	0x00,
}
...
func (m *ChatSingleReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TestStr) > 0 {
		...
		i = encodeVarintMainChat(dAtA, i, uint64(len(m.TestStr)))
		i--
		dAtA[i] = 0xa
	}
...
func encodeVarintMainChat(dAtA []byte, offset int, v uint64) int {
	offset -= sovMainChat(v)
	base := offset
	for v >= 1<<7 {
...
func sovMainChat(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozMainChat(x uint64) (n int) {
	return sovMainChat(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *ChatSingleReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthMainChat
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipMainChat(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipMainChat(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowMainChat
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthMainChat
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupMainChat
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthMainChat        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowMainChat          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupMainChat = fmt.Errorf("proto: unexpected end of group")
)
