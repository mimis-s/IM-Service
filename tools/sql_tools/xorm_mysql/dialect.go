...
// func NewDialect(driverName, dataSourceName string) (*XormMysql, error) {
// 	dialect, err := dialects.OpenDialect(driverName, dataSourceName)

// 	return &XormMysql{dialect}, err
// }
...
// func (x *XormMysql) Init(uri *dialects.URI) error {
// 	return x.Init(uri)
// }
// func (x *XormMysql) URI() *dialects.URI
// func (x *XormMysql) Version(ctx context.Context, queryer core.Queryer) (*schemas.Version, error)
// func (x *XormMysql) SQLType(*schemas.Column) string {
// 	var res string
...
// }
// func (x *XormMysql) Alias(string) string       // return what a sql type's alias of
// func (x *XormMysql) ColumnTypeKind(string) int // database column type kind
// func (x *XormMysql) IsReserved(string) bool
// func (x *XormMysql) Quoter() schemas.Quoter
// func (x *XormMysql) SetQuotePolicy(quotePolicy dialects.QuotePolicy)
// func (x *XormMysql) AutoIncrStr() string
// func (x *XormMysql) GetIndexes(queryer core.Queryer, ctx context.Context, tableName string) (map[string]*schemas.Index, error)
// func (x *XormMysql) IndexCheckSQL(tableName, idxName string) (string, []interface{})
// func (x *XormMysql) CreateIndexSQL(tableName string, index *schemas.Index) string
// func (x *XormMysql) DropIndexSQL(tableName string, index *schemas.Index) string
// func (x *XormMysql) GetTables(queryer core.Queryer, ctx context.Context) ([]*schemas.Table, error)
// func (x *XormMysql) IsTableExist(queryer core.Queryer, ctx context.Context, tableName string) (bool, error)
// func (x *XormMysql) CreateTableSQL(table *schemas.Table, tableName string) ([]string, bool)
// func (x *XormMysql) DropTableSQL(tableName string) (string, bool)
// func (x *XormMysql) GetColumns(queryer core.Queryer, ctx context.Context, tableName string) ([]string, map[string]*schemas.Column, error)
// func (x *XormMysql) IsColumnExist(queryer core.Queryer, ctx context.Context, tableName string, colName string) (bool, error)
// func (x *XormMysql) AddColumnSQL(tableName string, col *schemas.Column) string
// func (x *XormMysql) ModifyColumnSQL(tableName string, col *schemas.Column) string
// func (x *XormMysql) ForUpdateSQL(query string) string
// func (x *XormMysql) Filters() []dialects.Filter
// func (x *XormMysql) SetParams(params map[string]string)
...
func (db *XormMysql) Init(uri *dialects.URI) error {
...
func (db *XormMysql) SQLType(c *schemas.Column) string {
	...
	case schemas.TimeStampz:
		res = schemas.Char
		c.Length = 64
	case schemas.Enum: // XormMysql enum
		res = schemas.Enum
		res += "("
		opts := ""
		for v := range c.EnumOptions {
		...
		res += strings.TrimLeft(opts, ",")
		res += ")"
	case schemas.Set: // XormMysql set
		res = schemas.Set
		res += "("
		opts := ""
		for v := range c.SetOptions {
...
func (db *XormMysql) SetQuotePolicy(quotePolicy dialects.QuotePolicy) {
	switch quotePolicy {
...
func (db *XormMysql) CreateTableSQL(table *schemas.Table, tableName string) ([]string, bool) {
	if tableName == "" {
	...
	for i, colName := range table.ColumnsSeq() {
		...
		s, _ := dialects.ColumnString(db.dialect, col, col.IsPrimaryKey && len(table.PrimaryKeys) == 1)
		b.WriteString(s)
...
func (db *XormMysql) Filters() []dialects.Filter {
